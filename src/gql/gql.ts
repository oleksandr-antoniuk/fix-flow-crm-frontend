...
const documents = {
    ...
    "mutation CreateCurrency($data: CreateCurrencyInput!) {\n  createCurrency(data: $data) {\n    id\n    code\n    name\n    symbol\n    isRetailDefault\n  }\n}\n\nmutation SyncNbuRates {\n  syncNbuRates {\n    id\n    rate\n    createdAt\n    currency {\n      code\n    }\n  }\n}\n\nmutation EnsureDefaultCurrencies {\n  ensureDefaultCurrencies {\n    id\n    code\n    name\n    symbol\n    isRetailDefault\n  }\n}": types.CreateCurrencyDocument,
    ...
    "query Currencies {\n  currencies {\n    id\n    code\n    symbol\n    name\n    isRetailDefault\n    latestRate {\n      id\n      rate\n      createdAt\n    }\n  }\n}\n\nquery SupportedCurrencies {\n  supportedCurrencies {\n    code\n    symbol\n    name\n  }\n}\n\nquery ExchangeRates($currencyId: String, $take: Int) {\n  exchangeRates(currencyId: $currencyId, take: $take) {\n    id\n    rate\n    effectiveDate\n    currency {\n      code\n    }\n  }\n}": types.CurrenciesDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation CreateCurrency($data: CreateCurrencyInput!) {\n  createCurrency(data: $data) {\n    id\n    code\n    name\n    symbol\n    isRetailDefault\n  }\n}\n\nmutation SyncNbuRates {\n  syncNbuRates {\n    id\n    rate\n    createdAt\n    currency {\n      code\n    }\n  }\n}\n\nmutation EnsureDefaultCurrencies {\n  ensureDefaultCurrencies {\n    id\n    code\n    name\n    symbol\n    isRetailDefault\n  }\n}"): (typeof documents)["mutation CreateCurrency($data: CreateCurrencyInput!) {\n  createCurrency(data: $data) {\n    id\n    code\n    name\n    symbol\n    isRetailDefault\n  }\n}\n\nmutation SyncNbuRates {\n  syncNbuRates {\n    id\n    rate\n    createdAt\n    currency {\n      code\n    }\n  }\n}\n\nmutation EnsureDefaultCurrencies {\n  ensureDefaultCurrencies {\n    id\n    code\n    name\n    symbol\n    isRetailDefault\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
