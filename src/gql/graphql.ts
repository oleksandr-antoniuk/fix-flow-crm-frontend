...
export type CreateSparePartMutation = { __typename?: 'Mutation', createSparePart: { __typename?: 'SparePart', id: string, name: string, sku?: string | null } };
